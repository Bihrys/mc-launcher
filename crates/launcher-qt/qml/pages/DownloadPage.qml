...
Item {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    HmclButton {
                        ...
                        primary: true
                        enabled: !root.catalogTaskStatus.active
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    ListView {
                        ...
                        delegate: RemoteVersionCell {
                            width: versionList.width
                            style: root.style
                            versionId: model.versionId
                            subtitle: model.releaseTime
                            tagText: model.tagText
                            iconSource: model.iconSource
                            selected: root.selectedGameVersion === model.versionId
                            onClicked: root.selectVersion(index)
                        }
                    }
    ...
    component DownloadNavItem: Item {
        ...
        Rectangle {
            ...
            radius: 3
            color: item.selected
                   ? Qt.rgba(item.style.cAccent.r, item.style.cAccent.g, item.style.cAccent.b, 0.14)
        ...
        HmclSvgIcon {
            ...
            icon: item.iconKind
            iconSize: 22
            iconColor: item.selected ? item.style.cAccent : item.style.cTextOnSurfaceVariant
        ...
        Column {
            ...
            Text {
                width: parent.width
                text: item.title
                color: item.selected ? item.style.cAccent : item.style.cTextOnSurface
                font.pixelSize: 13
    ...
    component RemoteVersionCell: Item {
        ...
        Rectangle {
            ...
            radius: 3
            color: cell.selected
                   ? Qt.rgba(cell.style.cAccent.r, cell.style.cAccent.g, cell.style.cAccent.b, 0.14)
        ...
        Column {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    height: 20
                    radius: 2
                    color: Qt.rgba(cell.style.cAccent.r, cell.style.cAccent.g, cell.style.cAccent.b, 0.14)

                    Text {
                        id: tagText
                        anchors.centerIn: parent
                        text: cell.tagText
                        color: cell.style.cAccent
                        font.pixelSize: 10
                    }
                }
            }
    ...
    component LoaderChip: Item {
        ...
        Rectangle {
            ...
            radius: 16
            color: chip.selected
                   ? Qt.rgba(chip.style.cAccent.r, chip.style.cAccent.g, chip.style.cAccent.b, 0.16)
            ...
            border.color: chip.selected ? chip.style.cAccent : chip.style.cBorder
            border.width: 1
        }
        ...
        Text {
            ...
            anchors.centerIn: parent
            text: chip.text
            color: chip.selected ? chip.style.cAccent : chip.style.cTextOnSurface
            font.pixelSize: 12
    ...
    component HmclButton: Item {
        ...
        Text {
            anchors.centerIn: parent
            text: button.text
            color: button.primary ? button.style.cTextOnAccent : button.style.cTextOnSurface
            font.pixelSize: 12
