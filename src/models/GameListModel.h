...
public:
    ...
    enum Roles { InstanceIdRole = Qt::UserRole + 1, TitleRole, SubtitleRole, TagRole, IconNameRole, SelectedRole, CanUpdateRole, GameVersionRole, LoaderSummaryRole };
    ...
    Q_INVOKABLE QString duplicateInstance(const QString &id, const QString &newName, bool copySaves);
